...
function RegistrationSection({ title, description, rows, services, drafts, updateDraft, saveRow, saving, assigned, loading, filterValues = {}, setFilterValues, filterOptions = {} }) {
